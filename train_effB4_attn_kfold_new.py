...
train_dir = '/mnt/X/Ravi K/RIDD/New_data/'
# # # del train_AMD
# # # del train_non_AMD
gc.collect()
...
# base_model = EfficientNetB7(input_shape=img_dim, weights='imagenet', include_top=False) 
    ...
    predictions = Dense(28, activation='softmax', name='predictions')(x)
...
#print(model.summary())
print("ok")
X_train = np.load('/mnt/X/Ravi K/RIDD/New_data/Train_data2.npy')
Y_train = np.load('/mnt/X/Ravi K/RIDD/New_data/Train_label2.npy')
model_path = '/mnt/X/Ravi K/RIDD/New_data/model/'
log_path = '/mnt/X/Ravi K/RIDD/New_data/log/'
...
# model = ResNext(img_dim, depth=depth, cardinality=cardinality, width=width, weights=None, classes=num_classes)
# model.load_weights('/mnt/X/Aman/Opthalmology/cropped and resized data/trial 1 - Gauss Blur/model/effic_B7_noisy.001-2.148759-0.349434.h5')
# print("Model created")
...
# save_dir = ('/home/aman/Desktop/aman/RIDD challenge/trial-7 fold b4 28 class/fold 4/model/')
# model_name = 'effic_B4_noisy_attention1.{epoch:03d}-{val_loss:03f}-{val_acc:03f}.h5' 
# 
